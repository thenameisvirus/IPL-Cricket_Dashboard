...
function TeamComparison() {
  ...
  return (
    <section className="relative w-full min-w-0 overflow-hidden rounded-[28px] border border-white/[0.08] bg-gradient-to-br from-[#101827] via-[#0b1220] to-[#070b13] shadow-[0_30px_100px_rgba(0,0,0,0.35)]">
      {/* =====================================================
          AMBIENT BACKGROUND
      ===================================================== */}

      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -right-32 top-[20%] h-96 w-96 rounded-full bg-purple-500/[0.07] blur-[120px]" />

        <div className="absolute -bottom-32 left-[30%] h-80 w-80 rounded-full bg-orange-500/[0.05] blur-[110px]" />
      ...
      <div className="relative p-4 sm:p-6 lg:p-8">
        ...
        <header className="flex flex-col gap-5 border-b border-white/[0.06] pb-7 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex min-w-0 items-start gap-4">
            <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl border border-blue-400/15 bg-blue-500/10">
              <Swords
                size={27}
            ...
            <div className="min-w-0">
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="text-[8px] font-black uppercase tracking-[2.5px] text-blue-400 sm:text-[9px]">
                  Team Intelligence
                </span>
              </div>
        ...
        {error && (
          <div className="mt-5 flex items-start justify-between gap-4 rounded-2xl border border-red-400/10 bg-red-500/[0.05] p-4">
            <div className="flex min-w-0 items-start gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-1 break-words text-[10px] leading-5 text-red-400/60">
                  {error}
                </p>
              </div>
            </div>
        ...
        {dataLoading ? (
          ...
          <>
              ...
              <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                ...
                {result && (
                  <button
                    ...
                    className="w-fit rounded-xl border border-white/[0.07] bg-white/[0.025] px-3 py-2 text-[8px] font-black uppercase tracking-wider text-slate-500 transition hover:border-blue-400/20 hover:text-blue-300"
                  >
                    Reset
                  </button>
                )}
            ...
            <div className="mt-5 overflow-hidden rounded-2xl border border-white/[0.06] bg-black/[0.18]">
            ...
            {result && (
              <div className="mt-7">
                <div className="mb-5 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <div className="flex w-fit items-center gap-2 rounded-full border border-white/[0.06] bg-white/[0.025] px-3 py-2">
...
function TeamSelect({
  ...
  return (
    <div className="group min-w-0 rounded-2xl border border-white/[0.06] bg-white/[0.025] p-4 transition duration-300 hover:border-white/[0.10] hover:bg-white/[0.035]">
...
function PreviewTeam({
  ...
  return (
    <div
      className={`relative overflow-hidden rounded-2xl border ${styles.border} ${styles.bg} p-4 sm:p-5`}
    >
      <div className="absolute -right-10 -top-10 h-28 w-28 rounded-full bg-white/[0.02] blur-3xl" />

      <div className="relative flex min-w-0 items-center gap-4">
        <div
          className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border ${styles.border} ${styles.badge} text-xs font-black ${styles.text}`}
        >
          {initials || number}
        </div>
        ...
        <div className="min-w-0 flex-1">
          <span
            className={`text-[8px] font-black uppercase tracking-[1.5px] ${styles.text}`}
          >
            Team {number}
          </span>
        ...
        <Trophy
          size={18}
          className={`${styles.text} shrink-0 opacity-60`}
        />
      </div>
    </div>
  );
...
function ResultCard({
  ...
  return (
    <div className="group min-w-0 rounded-2xl border border-white/[0.06] bg-white/[0.025] p-5 transition duration-300 hover:-translate-y-0.5 hover:border-white/[0.10] hover:bg-white/[0.035]">
