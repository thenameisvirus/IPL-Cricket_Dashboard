  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden bg-[#040711] text-white">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="absolute -left-48 -top-48 h-[560px] w-[560px] rounded-full bg-orange-500/[0.055] blur-[150px]" />

        <div className="absolute right-[-220px] top-[18%] h-[620px] w-[620px] rounded-full bg-blue-500/[0.045] blur-[160px]" />

        <div className="absolute bottom-[-220px] left-[30%] h-[560px] w-[560px] rounded-full bg-purple-500/[0.045] blur-[150px]" />
        ...
        <main className="min-w-0 flex-1">
          ...
          <div className="mx-auto w-full max-w-[1750px] px-4 pb-12 pt-10 sm:px-6 sm:pt-12 lg:px-8 lg:pt-14 xl:px-10">
            ...
            <section className="relative overflow-hidden rounded-[32px] border border-white/[0.08] bg-gradient-to-br from-[#121a2a] via-[#0b1220] to-[#080c15] shadow-[0_30px_100px_rgba(0,0,0,0.38)]">
              ...
              <div className="absolute -right-32 -top-32 h-[430px] w-[430px] rounded-full bg-orange-500/[0.085] blur-[110px]" />

              <div className="absolute bottom-[-180px] left-[25%] h-[390px] w-[390px] rounded-full bg-blue-500/[0.05] blur-[110px]" />
                ...
                <div className="flex flex-col gap-8 xl:flex-row xl:items-center xl:justify-between">
                  ...
                  <div className="max-w-3xl">
                    ...
                    <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-orange-400/20 bg-orange-500/[0.07] px-4 py-2">
                      ...
                      <span className="text-[9px] font-black uppercase tracking-[2.4px] text-orange-300">
                    ...
                    (player, index) => {
                      ...
                      return (
                        <button
                          ...
                          className="group relative overflow-hidden rounded-[28px] border border-white/[0.08] bg-gradient-to-b from-[#131c2d] via-[#0d1524] to-[#080c15] text-left shadow-[0_22px_70px_rgba(0,0,0,0.28)] transition-all duration-500 hover:-translate-y-1.5 hover:border-orange-400/25 hover:shadow-[0_30px_90px_rgba(0,0,0,0.42)]"
                        >
                          ...
                          <div className="relative h-[340px] overflow-hidden bg-[#0b1220]">
                          ...
                          <div className="p-5">
                            ...
                            <div className="mt-4 flex items-center justify-between border-t border-white/[0.05] pt-4">
                              ...
                              <span className="text-[8px] font-black uppercase tracking-[1.5px] text-orange-400 transition group-hover:text-orange-300">
                                View Profile →
                              </span>
      ...
      {selectedPlayer && (
        <div
          className="fixed inset-0 z-[999] flex items-center justify-center bg-black/85 p-3 backdrop-blur-xl sm:p-6"
          onClick={() =>
        ...
        >
          ...
          >
            ...
            <div className="grid md:grid-cols-[340px_1fr]">
              ...
              <div className="relative min-h-[420px] overflow-hidden bg-[#0b1220]">
                ...
                {getImage(selectedPlayer) ? (
                  ...
                  <div className="flex h-full min-h-[420px] items-center justify-center bg-gradient-to-br from-orange-500/[0.12] via-[#101827] to-[#070b12]">
